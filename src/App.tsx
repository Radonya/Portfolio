...
import { FaReact, FaPython, FaVuejs, FaDocker, FaNodeJs, FaAws, FaDatabase, FaTools, FaWhatsapp, FaBriefcase, FaLaptopCode, FaSchool } from 'react-icons/fa';
...
const Button: React.FC<ButtonProps> = ({ primary = false, children, href, className = '' }) => {
  return (
    <motion.a
...
const QRCodeCard: React.FC<QRCodeCardProps> = ({ title, icon, qrCodeUrl, profileUrl }) => {
  return (
    <motion.div
      whileHover={{ y: -5 }}
...
const ProjectCategoryTabs: React.FC<ProjectCategoryTabsProps> = ({ activeCategory, setActiveCategory }) => {
  const categories = [
...
const App: React.FC = () => {
  // Fix dark mode state type and initialization
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 dark:text-white transition-colors duration-300 overflow-x-hidden">
      <nav className="fixed w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="hidden md:flex space-x-6 lg:space-x-8 mr-6">
              <a href="#home" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Accueil</a>
              <a href="#skills" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Compétences</a>
              <a href="#projects" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Projets</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white dark:bg-gray-900 py-4 px-4 fixed inset-0 z-50 flex flex-col justify-start pt-20">
            <button
            ...
            <div className="flex flex-col space-y-6 text-center text-xl bg-white dark:bg-gray-900">
              <a href="#home"
                onClick={() => setMobileMenuOpen(false)}
      ...
      <section id="home" className="relative flex items-center pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 opacity-10"></div>
          ...
          >
            <div className="max-w-xl w-full order-2 md:order-1">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8">
                <AnimatedText text="Je construis des applications web performantes et des infrastructures réseau sécurisées" />
              </p>
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 md:space-x-6">
                ...
                <Button href="#projects" primary>Voir les projets</Button>
              </div>
            </div>
            ...
            >
              <div className="relative w-64 h-64 sm:w-64 sm:h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
                <img
                  src="/Profile.png"
      ...
      <section id="projects" className="py-16 sm:py-20 px-4 sm:px-6 dark:bg-gray-800 transition-colors duration-300">
        <div className="container mx-auto max-w-6xl">
      ...
      <section id="skills" className="py-16 sm:py-20 bg-white dark:bg-gray-900 px-4 sm:px-6 transition-colors duration-300">
        <div className="container mx-auto max-w-6xl">
